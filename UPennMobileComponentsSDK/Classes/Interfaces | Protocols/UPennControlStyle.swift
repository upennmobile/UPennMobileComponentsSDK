...
public protocol UPennControlStyle {
    /**
     Builder method for modifying/updating UPennControlStyle objects and returning the modified object
     */
...
public extension UPennControlStylable {
    /**
     ...
     - parameters:
        ...
        - styles: UPennControlStyle object with all the style for modification
     */
