...
public struct UPennScreenGlobals {
    
    public static var Padding : CGFloat { return 16.0 }
    public static var Size : CGRect { return UIScreen.main.bounds }
